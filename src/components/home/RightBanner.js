...
export default function RightBanner() {
  return (
    <motion.div 
      ...
      animate = {{opacity:1, transition:{duration:1.2}, translateX: 0}}
      ...
      <Tilt options={{"glare-prerender": true}} style={{backgroundColor: '#212428'}}>
        <div 
            className=' w-auto h-auto xs:w-[285px] xs:h-[400px] sm:w-[320px] sml:h-[480px] md:w-[350px] md:h-[500px] mdl:w-[500px] mdl:h-[710px] lgl:w-[500px] lgl:h-[710px] bg-gradient-to-r 
